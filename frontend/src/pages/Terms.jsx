            ...
            <tbody>
              {[
                ...
                <tr key={i} style={i % 2 === 1 ? styles.trEven : {}}>
                  ...
                  <td style={{ ...styles.td, fontWeight: 600, color: '#0a192f' }}>{refund}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      return (
        <>
          ...
          <p style={{ ...styles.body, marginTop: '1rem', fontSize: '0.9375rem', color: '#4b5563' }}>
            For consumer disputes below ₹50,000, you may use the Online Consumer Dispute Redressal platform (<a href="https://consumerhelpline.gov.in" target="_blank" rel="noopener noreferrer" style={{ color: '#b8975a', fontWeight: 600, textDecoration: 'underline', textUnderlineOffset: '3px' }}>consumerhelpline.gov.in</a>).
          </p>
        </>
      );
        ...
        <>
          ...
          <div style={styles.contactGrid}>
            ...
            <div style={styles.contactCard}>
              ...
              <div style={styles.contactValue}>
                <a href="mailto:legal@travelgo.com" style={{ color: '#0a192f', textDecoration: 'underline', textDecorationColor: '#b8975a', textUnderlineOffset: '3px' }}>
                  legal@travelgo.com
                </a>
              </div>
