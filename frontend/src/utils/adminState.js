import {
  adminUsers as dummyUsers,
  bookings as dummyBookings,
  packages as dummyPackages,
...
export function initializeState() {
  seed(KEYS.USERS, dummyUsers);
  seed(KEYS.BOOKINGS, dummyBookings);
  seed(KEYS.PACKAGES, dummyPackages);
  seed(KEYS.DESTINATIONS, dummyDestinations);
  seed(KEYS.REVIEWS, dummyReviews);
  seed(KEYS.PAYMENTS, initialPayments);
  seed(KEYS.BLOGS, dummyBlogs);
