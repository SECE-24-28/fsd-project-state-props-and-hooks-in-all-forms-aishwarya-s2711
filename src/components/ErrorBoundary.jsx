    ...
    return (
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', justifyContent: 'center' }}>
          ...
          <a href="/" style={{ padding: '10px 24px', border: '2px solid #0a192f', borderRadius: 8, fontSize: 13, fontWeight: 600, textDecoration: 'none', fontFamily: 'DM Sans, sans-serif' }}>Go Home</a>
        </div>
      </div>
    );
  }
  ...
  render() {
    ...
    return (
      <div style={{
        ...
        <p style={{ color: '#0a192f', fontSize: 16, fontWeight: 500 }}>
          Page failed to load
        </p>
        <button
