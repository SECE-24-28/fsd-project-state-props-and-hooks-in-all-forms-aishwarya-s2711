              ...
              {CATEGORIES.map(cat => (
                <li key={cat}>
                  <button
                    ...
                    style={category === cat ? { background: '#0a192f', color: '#fff' } : { background: 'transparent', color: '#4a4a4a', border: '1px solid #e8e4dc' }}
                  >
                    {cat}
                  </button>
                </li>
              ...
              {CATEGORIES.map(cat => (
                <li key={cat}>
                  <button
                    ...
                    style={category === cat ? { background: '#b8975a', color: '#fff' } : { background: '#f5f5f5', color: '#333' }}
                  >
                    {cat}
                  </button>
                </li>
