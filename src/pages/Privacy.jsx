...
const s = {
  ...
  callout: {
    background: 'linear-gradient(135deg, rgba(184,151,90,0.06) 0%, rgba(248,246,242,0.8) 100%)',
  ...
  tocLink: (isActive) => ({
    ...
    borderRadius: '8px',
    color: isActive ? '#0a192f' : '#6b7280',
    background: isActive ? 'rgba(184,151,90,0.08)' : 'transparent',
    fontWeight: isActive ? 600 : 400,
    borderLeft: isActive ? '2.5px solid #b8975a' : '2.5px solid transparent',
  ...
  securityIcon: {
    ...
    height: '2rem',
    borderRadius: '8px',
    background: 'linear-gradient(135deg, #0a192f, #112a4a)',
    color: '#d4b483',
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
    ...
    case 'cookies':
      return (
        <>
          ...
          <div style={{ ...s.recommendation, background: 'rgba(184,151,90,0.06)', borderColor: 'rgba(184,151,90,0.2)', color: '#374151' }}>
          ...
          <div style={s.securityGrid}>
            {[
              ...
              <div key={i} style={s.securityCard}>
                ...
                <div>
                  <div style={{ fontWeight: 600, color: '#0a192f', fontSize: '0.9375rem', marginBottom: '0.125rem' }}>{item.label}</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginTop: '0.75rem' }}>
            {[
              ...
              <div key={i} style={s.rightCard}>
                ...
                <div>
                  <div style={{ fontWeight: 700, color: '#0a192f', fontSize: '0.9375rem', marginBottom: '0.125rem' }}>{right.title}</div>
            ...
            <tbody>
              {[
                ...
                <tr key={i} style={i % 2 === 1 ? s.trEven : {}}>
                  <td style={{ ...s.td, fontWeight: 500, color: '#0a192f' }}>{type}</td>
      ...
      return (
        <>
          ...
          <div style={s.contactGrid}>
            <div style={s.contactCard}>
              ...
              <div style={s.contactValue}>
                <a href="mailto:privacy@travelgo.com" style={{ color: '#0a192f', textDecoration: 'underline', textDecorationColor: '#b8975a', textUnderlineOffset: '3px' }}>
                  privacy@travelgo.com
                </a>
              </div>
            </div>
          ...
          <div style={{ marginTop: '1.25rem', padding: '0.875rem 1.125rem', borderRadius: '10px', background: 'rgba(248,246,242,0.7)', border: '1px solid #e8e4dc', fontSize: '0.9375rem', color: '#374151', lineHeight: 1.7 }}>
            <strong style={{ color: '#0a192f' }}>Response times:</strong> Within 3 business days for general inquiries · Within 30 days for formal data requests.
          </div>
        </>
      );
                ...
                <div style={s.articleCard}>
                  ...
                  <div style={{ textAlign: 'center', paddingTop: '1.5rem', borderTop: '1px solid #e8e4dc' }}>
                    <a
                      ...
                      onMouseLeave={e => e.currentTarget.style.color = '#b8975a'}
                    >
                      ↑ Back to Top
                    </a>
                  </div>
