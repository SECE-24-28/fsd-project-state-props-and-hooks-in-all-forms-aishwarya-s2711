            ...
            <tbody className="divide-y divide-slate-100">
              {bookings.slice(0, 5).map(b => (
                <tr key={b.id} className="hover:bg-slate-50 transition-colors">
                  <td className="px-6 py-4 text-sm font-medium text-slate-900">{b.id}</td>
                  <td className="px-6 py-4 text-sm text-slate-600">{b.user}</td>
                  <td className="px-6 py-4 text-sm text-slate-600">{b.tour}</td>
                  <td className="px-6 py-4 text-sm font-medium text-slate-900">${b.amount}</td>
