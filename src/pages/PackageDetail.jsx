                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-[0.8125rem]" style={{ color: '#4b5563' }}>
                    ...
                    <span className="flex items-center gap-1.5">
                      <FiStar size={14} style={{ color: '#b8975a', fill: '#b8975a' }} />
                      ...
                      {pkg.itinerary?.map((day, i) => (
                        <motion.div key={i}
                          ...
                          <div className="pb-6 flex-1">
                            <h4 className="font-semibold mb-1" style={{ color: '#0a192f', fontSize: '0.9375rem' }}>{day.title}</h4>
          ...
          <aside>
            <div className="rounded-2xl p-6 sticky top-28" style={{ background: '#fff', boxShadow: '0 12px 40px rgba(10,25,47,0.10)' }}>
              ...
              <form onSubmit={handleBooking} className="space-y-4" aria-label="Booking form">
                <div>
                  <label htmlFor="book-name" className="block text-sm font-semibold mb-1.5" style={{ color: '#0a192f' }}>Full Name</label>
                ...
                <div>
                  <label htmlFor="book-email" className="block text-sm font-semibold mb-1.5" style={{ color: '#0a192f' }}>Email</label>
                ...
                <div>
                  <label htmlFor="book-date" className="block text-sm font-semibold mb-1.5" style={{ color: '#0a192f' }}>Travel Date</label>
                ...
                <div>
                  <label htmlFor="book-persons" className="block text-sm font-semibold mb-1.5" style={{ color: '#0a192f' }}>Travelers</label>
                  <div className="relative">
