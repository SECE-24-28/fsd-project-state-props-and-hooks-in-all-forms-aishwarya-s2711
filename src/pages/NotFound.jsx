  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden page-enter"
        style={{ background: 'linear-gradient(135deg, #0a192f 0%, #112a4a 60%, #1a3a5c 100%)' }}>
        ...
        <div className="relative text-center px-6 py-20 max-w-2xl">
          ...
          >
            <p className="font-light mb-2" style={{
              ...
              lineHeight: 1,
              background: 'linear-gradient(135deg, #b8975a 0%, #e8d5a3 50%, #b8975a 100%)',
          ...
          >
            <div className="h-px max-w-xs mx-auto mb-8"
              style={{ background: 'linear-gradient(90deg, transparent, rgba(184,151,90,0.5), transparent)' }} />
          ...
          >
            {SUGGESTIONS.map(s => (
              <Link
                ...
                onMouseEnter={e => { e.currentTarget.style.background = 'rgba(184,151,90,0.12)'; e.currentTarget.style.borderColor = 'rgba(184,151,90,0.35)'; e.currentTarget.style.color = '#d4b483'; }}
