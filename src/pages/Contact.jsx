            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-16">
              {CONTACTS.map(({ Icon, title, lines }, i) => (
                <motion.div key={i}
                  ...
                  onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(184,151,90,0.30)'; e.currentTarget.style.boxShadow = '0 8px 32px rgba(10,25,47,0.10)'; }}
                ...
                >
                  <div className="w-12 h-12 rounded-2xl flex items-center justify-center mx-auto mb-4 transition-all"
                    ...
                    <Icon style={{ color: '#b8975a' }} size={20} />
                  </div>
                  <h3 className="font-semibold text-sm mb-2" style={{ fontFamily: 'Cormorant Garamond, serif', color: '#0a192f', fontSize: '1rem' }}>
                    {title}
                  </h3>
                  {lines.map((l, j) => <p key={j} className="text-xs" style={{ color: '#888', lineHeight: 1.8 }}>{l}</p>)}
                </motion.div>
              ))}
            </div>
              ...
              >
                {sent ? (
                  <div className="text-center py-16">
                    ...
                    <h3 className="text-3xl font-light mb-3" style={{ fontFamily: 'Cormorant Garamond, serif', color: '#0a192f' }}>
                      Message Sent!
                    </h3>
                    <p className="text-sm mb-8" style={{ color: '#888' }}>Our team will respond within 24 hours.</p>
                  ...
                  <>
                    <div className="mb-8">
                      ...
                      <h2 className="text-3xl font-light mt-2" style={{ fontFamily: 'Cormorant Garamond, serif', color: '#0a192f' }}>
                        Plan Your Journey
                      </h2>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} noValidate aria-label="Contact form">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                          <label htmlFor="contact-name" className="block text-xs font-semibold mb-1.5 tracking-wide" style={{ color: '#0a192f' }}>
                            Full Name <span style={{ color: '#b8975a' }}>*</span>
                          </label>
                        ...
                        <div>
                          <label htmlFor="contact-email" className="block text-xs font-semibold mb-1.5 tracking-wide" style={{ color: '#0a192f' }}>
                            Email <span style={{ color: '#b8975a' }}>*</span>
                          </label>
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                          <label htmlFor="contact-phone" className="block text-xs font-semibold mb-1.5 tracking-wide" style={{ color: '#0a192f' }}>Phone</label>
                        ...
                        <div>
                          <label htmlFor="contact-subject" className="block text-xs font-semibold mb-1.5 tracking-wide" style={{ color: '#0a192f' }}>Subject</label>
                          <select id="contact-subject" value={form.subject} onChange={e => set('subject', e.target.value)} className="form-input">
                      ...
                      <div className="mb-6">
                        <label htmlFor="contact-message" className="block text-xs font-semibold mb-1.5 tracking-wide" style={{ color: '#0a192f' }}>
                          Message <span style={{ color: '#b8975a' }}>*</span>
                        </label>
                        <textarea id="contact-message" required rows={5} value={form.message} onChange={e => set('message', e.target.value)}
                          className="form-input resize-none" placeholder="Tell us about your dream trip..."
                  ...
                  <Marker position={[19.0596, 72.8295]}>
                    <Popup>
                      <div style={{ fontFamily: 'DM Sans, sans-serif', padding: '4px' }}>
                        <strong style={{ color: '#0a192f' }}>TravelGo HQ</strong><br />
