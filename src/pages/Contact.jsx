                    ...
                    <form onSubmit={handleSubmit} noValidate aria-label="Contact form">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                          ...
                          <label htmlFor="contact-name" className="block text-sm font-semibold mb-1.5 tracking-wide" style={{ color: '#0a192f' }}>
                        ...
                        <div>
                          <label htmlFor="contact-email" className="block text-sm font-semibold mb-1.5 tracking-wide" style={{ color: '#0a192f' }}>
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                          <label htmlFor="contact-phone" className="block text-sm font-semibold mb-1.5 tracking-wide" style={{ color: '#0a192f' }}>Phone</label>
                        ...
                        <div>
                          <label htmlFor="contact-subject" className="block text-sm font-semibold mb-1.5 tracking-wide" style={{ color: '#0a192f' }}>Subject</label>
                      ...
                      <div className="mb-6">
                        <label htmlFor="contact-message" className="block text-sm font-semibold mb-1.5 tracking-wide" style={{ color: '#0a192f' }}>
